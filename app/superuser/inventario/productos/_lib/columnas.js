...
export const COLUMNAS = [
    ...
    { key: 'codigoBarrasCaja', label: 'Cód. barras caja', ancho: 118, tipo: 'texto', campo: 'codigoBarrasCaja', ayuda: 'Código de barras impreso en la CAJA cerrada. Vacío si la caja no trae.' },
    { key: 'codigoBarrasBulto', label: 'Cód. barras bulto', ancho: 118, tipo: 'texto', campo: 'codigoBarrasBulto', ayuda: 'Código de barras impreso en el BULTO. Vacío si el bulto no trae.' },
    ...
    {
        key: 'stockCajas', label: 'Stock cajas', ancho: 76, tipo: 'numero', derecha: true, decimales: [0, 2],
    ...
    {
        key: 'stockBultos', label: 'Stock bultos', ancho: 80, tipo: 'numero', derecha: true, decimales: [0, 2],
    ...
    { key: 'unidadesPorCaja', label: 'Und/caja', ancho: 70, tipo: 'numero', campo: 'unidadesPorCaja', decimales: [0, 0], derecha: true, ayuda: 'Unidades que trae cada caja' },
    { key: 'cajasPorBulto', label: 'Cajas/bulto', ancho: 78, tipo: 'numero', campo: 'cajasPorBulto', decimales: [0, 0], derecha: true, ayuda: 'Cajas que trae el bulto' },
